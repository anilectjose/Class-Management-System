...
$result=mysqli_query($con,"SELECT * FROM `student_db` join role_db on role_db.role_id=student_db.role_id where student_db.year=3");
...
?>
   ...
   ?>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> Third Years</h1>
          <p></p>
        </div>
